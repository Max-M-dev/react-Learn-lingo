...
type BookFormProps = TeacherProps & { onClose: () => void };

const BookForm: React.FC<BookFormProps> = ({ teacher, onClose }) => {
        ...
        <div className={css.radiobox}>
          ...
          <div className={css.div}>
            <input
              ...
              id="career"
            />
            <label className={css.option} htmlFor="career">
              Career and business
            </label>
          </div>
          <div className={css.div}>
            <input
              ...
              id="kids"
            />
            <label className={css.option} htmlFor="kids">
              Lesson for kids
            </label>
          </div>
          <div className={css.div}>
            <input
              ...
              id="abroad"
            />
            <label className={css.option} htmlFor="abroad">
              Living abroad
            </label>
          </div>
          <div className={css.div}>
            <input
              ...
              id="exams"
            />
            <label className={css.option} htmlFor="exams">
          ...
          <div className={css.div}>
            <input
              ...
              id="hobby"
            />
            <label className={css.option} htmlFor="hobby">
